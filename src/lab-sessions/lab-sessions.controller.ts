...
export class LabSessionsController {
    ...
    @ApiResponse({
        status: 201,
        description: 'The lab session has been successfully created.',
    })
    ...
    @ApiResponse({
        status: 200,
        description: 'The lab session has been successfully updated.',
    })
    @ApiResponse({ status: 404, description: 'Lab session not found.' })
    @ApiResponse({ status: 403, description: 'Forbidden.' })
    update(
        @Param('id') id: string,
        @Body() updateLabSessionDto: UpdateLabSessionDto,
    ) {
    ...
    @ApiResponse({
        status: 200,
        description: 'The lab session has been successfully deleted.',
    })
    @ApiResponse({ status: 404, description: 'Lab session not found.' })
    @ApiResponse({ status: 403, description: 'Forbidden.' })
