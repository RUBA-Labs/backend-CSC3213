...
export class ComputerLabsController {
    ...
    @ApiResponse({
        status: 201,
        description: 'The computer lab has been successfully created.',
    })
    ...
    @ApiResponse({
        status: 200,
        description: 'The computer lab has been successfully updated.',
    })
    @ApiResponse({ status: 404, description: 'Computer lab not found.' })
    @ApiResponse({ status: 403, description: 'Forbidden.' })
    update(
        @Param('id') id: string,
        @Body() updateComputerLabDto: UpdateComputerLabDto,
    ) {
    ...
    @ApiResponse({
        status: 200,
        description: 'The computer lab has been successfully deleted.',
    })
    @ApiResponse({ status: 404, description: 'Computer lab not found.' })
    @ApiResponse({ status: 403, description: 'Forbidden.' })
